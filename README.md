...
<!-- Main Content -->
  ...
  <div style="flex: 1; min-width: 300px;">
    ...
    <div style="font-size: 1.25rem; line-height: 1.8; color: #1a1a1a;">
     <p>I’m Chante’ Johnson, a technologist and learning experience designer with a passion for clarity, inclusion, and lifelong learning. Originally from Harlem, New York, I’ve lived in New Jersey, Pennsylvania, Maryland, and now call Texas home. Every move, every challenge has been a lesson—and I carry that mindset into everything I create.</p>
      ...
      <p>I stay current with emerging technologies like AI by attending workshops, following industry podcasts, and engaging with thought leaders. I built this portfolio site from scratch to showcase not just what I do, but who I am: someone committed to innovation, equity, and using technology to make a meaningful impact.</p> 
